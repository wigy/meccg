 ...
 * validated by eye.
 */
export const ALL_MODULES: readonly H2Module[] = [charactersModule, killModule, combatModule, corruptionModule, endgameModule, factionsModule, fetchingModule, grantsModule, handModule, hazardsModule, healthModule, resourcesModule, travelModule];
