...
export const TUTORIAL_STEPS: readonly TutorialStepInfo[] = [
  ...
  { id: 'site-select', title: 'A Haven to start from', body: 'Wizard companies begin at Rivendell. Select it from your site deck. (Two-site avatars — Ringwraiths, the Balrog — would also place characters between sites here.)' },
  { id: 'deck-shuffle', title: 'Shuffle up', body: 'Normally this shuffles your play deck. In the tutorial the order is fixed so every draw can be explained.' },
...
export const TUTORIAL_BEATS: readonly TutorialBeat[] = [
  ...
  b('site-select', 'human', { type: 'select-starting-site', cardDef: RIVENDELL }),
  b('site-select', 'human', { type: 'pass' }),
  b('site-select', 'mentor', { type: 'select-starting-site', cardDef: RIVENDELL }),
  b('site-select', 'mentor', { type: 'pass' }),
