...
export { CHARACTER_DRAFT_RULES, STAGE_RESOURCE_DRAFT_RULES } from './definitions/character-draft.js';
...
export { createMovementRules, BASE_MAX_REGION_DISTANCE, AGENT_MAX_REGION_DISTANCE } from './definitions/movement.js';
