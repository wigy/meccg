...
export type GameAction =
  ...
  | PassAction
  | ConcedeAction
  | ProposeEarlyCouncilAction
  | AcceptEarlyCouncilAction
  | DeclineEarlyCouncilAction
  | CallFreeCouncilAction
  | DeckExhaustAction
  | ExchangeSideboardAction
  | SwapBannedVsBalrogAction
