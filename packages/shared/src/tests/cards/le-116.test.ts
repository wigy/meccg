 ...
 * @module le-116.test
 *
 * Card test: Incite Denizens (le-116)
...
import type { GameState, MovementHazardPhaseState, SitePhaseState, CardDefinitionId, CompanyId, CardInstanceId } from '../../index.js';

const INCITE_DENIZENS = 'le-116' as CardDefinitionId;

// ─── Tests ────────────────────────────────────────────────────────────────────

describe('Incite Denizens (le-116)', () => {
