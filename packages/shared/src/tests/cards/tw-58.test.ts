 ...
 * @module tw-58.test
 *
 * Card test: Lure of Nature (tw-58)
 * Type: hazard-event (permanent, character-targeting)
 *
 * tw-58 is the original The Wizards printing of Lure of Nature; le-123 is the
 * word-for-word identical Lidless Eye reprint (already certified). Both carry
 * the same five effects:
 *   - play-target character filter non-hobbit/non-dwarf/non-orc/non-ringwraith,
