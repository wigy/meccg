 ...
 *
 * Keyed to (playable {s}{d}{S}{D}): Shadow-land [{s}] or Dark-domain [{d}]
 *   region types, or Shadow-hold [{S}] or Dark-hold [{D}] site types.
 *   Encoded as one keyedTo entry combining regionTypes + siteTypes; the
 *   keying matcher OR's the members, so any one of the four keys the creature.
 *
 * le-72 is the Lidless Eye reprint of tw-37 — identical text, stats and keying.
 *
