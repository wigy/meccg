 ...
 *   - EDHELLOND (as-145):  free-hold, gold-ring NOT playable    ← invalid (no gold-ring)
...
const EDHELLOND = 'as-145' as CardDefinitionId;
...
describe('Bright Gold Ring (le-303)', () => {
  ...
  test('not offered at Edhellond (free-hold without gold-ring)', () => {
    const base = buildTestState({
      activePlayer: PLAYER_1,
      recompute: true,
      players: [
        { id: PLAYER_1, companies: [{ site: EDHELLOND, characters: [GORBAG] }], hand: [], siteDeck: [ETTENMOORS] },
        { id: PLAYER_2, companies: [{ site: DOL_GULDUR, characters: [SHAGRAT] }], hand: [], siteDeck: [MINAS_MORGUL] },
      ],
      phase: Phase.Site,
    });
