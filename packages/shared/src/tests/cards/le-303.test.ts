 ...
 *   - BLUE_MOUNTAIN_DWARF_HOLD (le-355): free-hold, nothing playable ← invalid (no gold-ring)
...
describe('Bright Gold Ring (le-303)', () => {
  ...
  test('not offered at Blue Mountain Dwarf-hold (free-hold without gold-ring)', () => {
    const base = buildTestState({
      ...
      recompute: true,
      players: [
        { id: PLAYER_1, companies: [{ site: BLUE_MOUNTAIN_DWARF_HOLD, characters: [GORBAG] }], hand: [], siteDeck: [ETTENMOORS] },
        { id: PLAYER_2, companies: [{ site: DOL_GULDUR, characters: [SHAGRAT] }], hand: [], siteDeck: [MINAS_MORGUL] },
      ],
      phase: Phase.Site,
    });
