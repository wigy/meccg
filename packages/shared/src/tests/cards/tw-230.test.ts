 ...
 *   3. set-character-status — wounds the targeted character (inverted), no body check
 *
...
const ESCAPE = 'tw-230' as CardDefinitionId;

describe('Escape (tw-230)', () => {
  ...
  test('NOT offered as play-short-event during end-of-turn (no attack to cancel)', () => {
    ...
    // end-of-turn because play-target and set-character-status were not
