 ...
 *
 * le-61 is the Lidless Eye reprint of tw-015 — identical text, stats and keying.
 */
...
const BARROW_WIGHT_LE = 'le-61' as CardDefinitionId;
const SHADOW_KEYING = { method: 'region-type' as const, value: 'shadow' };

describe('Barrow-wight (le-61)', () => {
  ...
  test('combat initiates with 1 strike and 12 prowess', () => {
    const state = buildTestState({
      ...
      players: [
        ...
        { id: PLAYER_2, companies: [{ site: LORIEN, characters: [LEGOLAS] }], hand: [BARROW_WIGHT_LE], siteDeck: [RIVENDELL] },
      ],
    });
