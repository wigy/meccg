 ...
 *
 * Card text:
 *   "Unique. Playable at Minas Morgul if the influence check is greater
 *    than 8. Once in play, the number required to influence this faction
 *    is 0. Standard Modifications: Ungol-orcs (-2), Orcs of Angmar (+2)."
 *
 ...
 *    faction play at a haven (CoE 2.V.3).
 ...
 *  - The card carries **no** leader-control clause, so no
 *    `placeUnderLeaderControl` variant may be offered.
 *
...
describe('Morgul-orcs (as-119)', () => {
  ...
  test('opponent re-influence of the in-play faction uses value 0', () => {
    ...
    // PLAYER_2 controls the faction; PLAYER_1 is the active player at
    // Minas Morgul, the site where the faction is playable.
