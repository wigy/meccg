...
describe('Legolas (tw-168)', () => {
  ...
  test('+2 direct influence against Wood-elves faction', () => {
    ...
    // influenceNumber(9) - baseDI(2) - legolasBonus(2) - elfCheckMod(1) = 4
  ...
  test('+2 DI bonus does not apply to other characters', () => {
    ...
    // influenceNumber(9) - baseDI(3) = 6 (no Legolas-specific bonus, dunadan has no check modifier)
