 ...
 * @module ba-90.test
 *
 * Card test: The Gem-deeps (ba-90)
 * Type: balrog-site (ruins-and-lairs, under-deeps) in Gap of Isen
 *
 * Text:
 ...
 *
 * This is the Balrog reprint of The Gem-deeps (hero dm-30 / minion as-149);
 * identical rules, balrog-side draws (1/1) and shorter Pûkel-deeps adjacency (8).
 *
 * Data encoding (filled/added this pass; the imported data dropped all three):
 *   - `playableResources: [minor, major, gold-ring]` — was `[]` despite the
 *     printed "Playable" line (the recurring BA/LE-site empty-playableResources
 *     bug).
 ...
 *   (`site-rule: dynamic-auto-attack` keyed to Shadow-hold {S} was already present.)
 *
 ...
 * | 5 | playableResources | OK     | [minor, major, gold-ring] — fixed this pass      |
 * | 6 | automaticAttacks  | OK     | Undead, 3 strikes, 9 prowess (1st attack)        |
 * | 7 | resourceDraws     | OK     | 1                                                |
 * | 8 | hazardDraws       | OK     | 1                                                |
 * | 9 | keywords          | OK     | ["under-deeps"]                                  |
 * | 10| adjacentSites     | OK     | Glittering Caves (0), Pûkel-deeps (8), Under-gates (6) |
 ...
 * | 5 | Any Undead may be keyed here (Special)              | IMPLEMENTED | allow-creature-by-race race "undead" → M/H keying bypass |
 * | 6 | Any Pûkel-creature may be keyed here (Special)      | IMPLEMENTED | allow-creature-by-race race "pûkel-creature" → M/H keying bypass |
 *
 * Playable: YES
 */
...
const THE_UNDER_GROTTOS = 'ba-101' as CardDefinitionId; // ruins-and-lairs, under-deeps, NO allow-creature-by-race (baseline)
...
/** Balrog company (Crook-legged Orc) at The Gem-deeps in the site phase, given `hand`. */
function siteWithHand(hand: CardDefinitionId[]): GameState {
  const state = buildTestState({
    ...
    recompute: true,
    players: [
      { id: PLAYER_1, alignment: Alignment.Balrog, companies: [{ site: THE_GEM_DEEPS, characters: [CROOK_LEGGED_ORC] }], hand, siteDeck: [THE_UNDER_GATES_BA] },
...
/** Balrog company at The Gem-deeps at a chosen site-phase step; hazard hand configurable. */
...
/** A Balrog company at The Gem-deeps, sitting at the automatic-attacks step. */
...
/**
 * Balrog company at a ruins-and-lairs under-deeps site in the movement/hazard
...
describe('The Gem-deeps (ba-90)', () => {
  ...
  // ─── Special: any Undead may be keyed to this site ─────────────────────────
  ...
  test('Barrow-wight is NOT keyable at a baseline R&L under-deeps site without the Special (The Under-grottos)', () => {
    // The Under-grottos (ba-101) is ruins-and-lairs, under-deeps, with no
  ...
  // ─── Special: any Pûkel-creature may be keyed to this site ─────────────────
