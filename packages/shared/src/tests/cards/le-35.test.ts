 ...
 *
 * Rules exercised:
 * 1. discardBodyCheck [8]: the orc is discarded when the modified body-check
...
describe('Orc Veteran (le-35)', () => {
  ...
  test('Orc Veteran is discarded when the modified total matches his discard value', () => {
  ...
  test('Orc Veteran stays in play when body check passes', () => {
    // discardBodyCheck = [8]; Veils Flung Away applies a -1 roll modifier (CoE 3.I.1).
