 ...
 * @module le-109.test
 *
 * Card test: Despair of the Heart (le-109)
 ...
 *  a given character."
 *
 * An LE reprint of the identical tw-27 card (same text, same effects). See
 * tw-27.test.ts for the certified precedent this test mirrors.
 *
 * Effects:
...
const DESPAIR_OF_THE_HEART = 'le-109' as CardDefinitionId;

const WILDERNESS_KEYING = { method: 'region-type' as const, value: 'wilderness' };

describe('Despair of the Heart (le-109)', () => {
