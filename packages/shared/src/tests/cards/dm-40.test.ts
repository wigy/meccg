 ...
 * Effects: 1 — site-rule: dynamic-auto-attack (keyed to {R}, non-unique only)
 *
 * Text:
 ...
 * | 7 | effects           | OK       | dynamic-auto-attack keyed to {R}, nonUnique: true  |
 ...
 * | 3 | dynamic-auto-attack (2nd attack)    | IMPLEMENTED     | play-site-auto-attack step; non-unique filter added |
 * | 4 | Static auto-attack (Orcs 5/7)       | IMPLEMENTED     | automaticAttacks data used in combat initiation     |
 * | 5 | Witch-king of Angmar special        | NOT IMPLEMENTED | permanent-event as additional auto-attack           |
 * | 6 | Under-deeps movement (adjacentSites)| NOT IMPLEMENTED | movement roll and adjacentSites not in engine       |
 *
 * Playable: PARTIALLY
 * NOT CERTIFIED — the Witch-king of Angmar special rule (permanent-event as an
 *   additional automatic-attack, discarded after use, defeat result ignored) has no
 *   engine support. Under-deeps movement (adjacentSites roll) is also engine-wide
