 ...
 * @module tw-42.test
 *
 * Card test: Greed (tw-42) — hazard-event (short)
 *
 ...
 *
 * This is the TW printing of the same card certified as le-113 (LE printing);
 * see `le-pending-effects-parity.test.ts` for the effect-array parity guard
 * between the two. This file exercises tw-42's own engine behavior directly,
 * mirroring the le-113 coverage.
 *
 * Effects:
 *   1. play-target site
...
const GREED = 'tw-42' as CardDefinitionId;
