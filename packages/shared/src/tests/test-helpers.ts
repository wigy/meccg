...
import {
  ...
  THEODEN, ELROND, CELEBORN, GLORFINDEL_II, HALDIR, GANDALF,
  ...
  RIVENDELL, LORIEN, MORIA, MINAS_TIRITH, MOUNT_DOOM, THRANDUILS_HALLS, DOL_AMROTH,
  WOOD_ELVES, KNIGHTS_OF_DOL_AMROTH,
} from '../index.js';
