...
import {
  ...
  GWAIHIR, TREEBEARD,
  ASSASSIN, CAVE_DRAKE, ORC_GUARD, ORC_LIEUTENANT, ORC_PATROL, ORC_WATCH, BARROW_WIGHT, BERT_BURAT, TOM_TUMA, WILLIAM_WULUAG, HOBGOBLINS, FOOLISH_WORDS, LURE_OF_THE_SENSES, ALONE_AND_UNADVISED, LOST_IN_FREE_DOMAINS, STEALTH, RIVER,
