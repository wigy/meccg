...
import {
  ...
  EOWYN, BEREGOND, BERGIL, BARD_BOWMAN, ANBORN, SAM_GAMGEE, PEATH,
  ...
  CRAM, SCROLL_OF_ISILDUR, PALANTIR_OF_ORTHANC,
  GWAIHIR,
  ASSASSIN, CAVE_DRAKE, ORC_LIEUTENANT, ORC_PATROL, BARROW_WIGHT, BERT_BURAT, TOM_TUMA, WILLIAM_WULUAG, HOBGOBLINS, FOOLISH_WORDS, LURE_OF_THE_SENSES, LOST_IN_FREE_DOMAINS, STEALTH, RIVER,
  SUN, EYE_OF_SAURON, GATES_OF_MORNING, TWILIGHT, DOORS_OF_NIGHT, SMOKE_RINGS, CONCEALMENT, DODGE, DARK_QUARRELS, HALFLING_STRENGTH, MARVELS_TOLD, LITTLE_SNUFFLER,
