...
import {
  ...
  SUN, EYE_OF_SAURON, GATES_OF_MORNING, TWILIGHT, DOORS_OF_NIGHT, SMOKE_RINGS, CONCEALMENT, DODGE, DARK_QUARRELS, HALFLING_STRENGTH, GREAT_SHIP, MARVELS_TOLD, LITTLE_SNUFFLER, AND_FORTH_HE_HASTENED, WIZARDS_LAUGHTER, VANISHMENT,
