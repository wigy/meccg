...
import {
  ...
  EOWYN, BEREGOND, BERGIL, BARD_BOWMAN, ANBORN, SAM_GAMGEE, FATTY_BOLGER, PEATH,
  THEODEN, ELROND, CELEBORN, GALADRIEL, GLORFINDEL_II, HALDIR, GANDALF, BALIN, KILI,
  SARUMAN, IORETH,
  GLAMDRING, STING, THE_MITHRIL_COAT, THE_ONE_RING, DAGGER_OF_WESTERNESSE, HORN_OF_ANOR, PRECIOUS_GOLD_RING, HAUBERK_OF_BRIGHT_MAIL,
  CRAM, SCROLL_OF_ISILDUR, PALANTIR_OF_ORTHANC, SAPLING_OF_THE_WHITE_TREE,
  GWAIHIR, TREEBEARD,
  ASSASSIN, CAVE_DRAKE, ORC_GUARD, ORC_WARBAND, ORC_LIEUTENANT, ORC_PATROL, ORC_WATCH, BARROW_WIGHT, BERT_BURAT, TOM_TUMA, WILLIAM_WULUAG, HOBGOBLINS, FOOLISH_WORDS, LURE_OF_THE_SENSES, LOST_IN_FREE_DOMAINS, STEALTH, RIVER,
  SUN, EYE_OF_SAURON, GATES_OF_MORNING, TWILIGHT, DOORS_OF_NIGHT, CHOKING_SHADOWS, SMOKE_RINGS, CONCEALMENT, DODGE, DARK_QUARRELS, HALFLING_STRENGTH, MARVELS_TOLD, LITTLE_SNUFFLER, AND_FORTH_HE_HASTENED, WIZARDS_LAUGHTER, VANISHMENT,
  AN_UNEXPECTED_OUTPOST,
