/**
 * @module rule-1.46-balrog-draft-six
 *
 * CoE Rules — Section 1: Deck Construction & Setup
 * Rule 1.46: Balrog Draft Six Characters
 *
 ...
 * RULING:
 *
 * [BALROG] A Balrog player may draft up to six starting characters instead of five.
 */
...
// Six low-mind minion characters for the Balrog player (total mind 9, well under 20)
...
describe('Rule 1.46 — Balrog Draft Six Characters', () => {
  test('[BALROG] Balrog player may draft up to six starting characters instead of five', () => {
    // P1 is Balrog with 6 low-mind characters in pool.
    ...
    // After 5 characters drafted, Balrog has NOT hit their limit (max is 6).
    ...
    // After 6 characters drafted, Balrog is at max — no more picks available.
