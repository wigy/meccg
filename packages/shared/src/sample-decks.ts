...
import {
  ...
  // Hero items
  GLAMDRING, THE_MITHRIL_COAT, THE_ONE_RING, DAGGER_OF_WESTERNESSE, HORN_OF_ANOR,
  // Hero allies
  GWAIHIR, SHADOWFAX,
  // Hero factions
  ...
  // Hazard events
  DOORS_OF_NIGHT, EYE_OF_SAURON, WAKE_OF_WAR, TWILIGHT,
  // Minion items
...
const heroDeck: SampleDeck = {
  ...
  buildJoinMessage(playerName: string): JoinMessage {
    ...
    const uniqueResources = [GLAMDRING, THE_MITHRIL_COAT, THE_ONE_RING,
