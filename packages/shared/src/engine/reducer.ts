...
export function reduce(state: GameState, action: GameAction): ReducerResult {
  ...
  const combatActionTypes = ['assign-strike', 'choose-strike-order', 'resolve-strike', 'support-strike', 'body-check-roll', 'shield-discard-roll', 'cancel-attack', 'cancel-by-tap', 'cancel-strike', 'protect-from-assignment', 'play-strike-event', 'halve-strikes', 'modify-attack', 'tap-item-for-strike', 'salvage-item', 'discard-item-from-company', 'play-hazard', 'haven-join-attack', 'play-short-event', 'agent-strike-roll', 'take-trophy'];
