...
export function reduce(state: GameState, action: GameAction): ReducerResult {
  ...
  const combatActionTypes = ['assign-strike', 'choose-strike-order', 'resolve-strike', 'support-strike', 'body-check-roll', 'cancel-attack', 'cancel-by-tap', 'play-dodge', 'halve-strikes', 'salvage-item'];
