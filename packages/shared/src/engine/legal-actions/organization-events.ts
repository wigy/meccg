    ...
    if (sitePlayTarget) {
      ...
      if (!orgPhaseSiteTiming && discardNamedCardCond?.cardName) {
        ...
        for (const { company, siteDefId, siteDef } of companiesAtMatchingSite(state, player, def, sitePlayTarget)) {
          ...
          const discardCandidates = companyDiscardCandidates(
