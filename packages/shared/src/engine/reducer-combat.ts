...
import { cardName, clonePlayers, companyById, companySubphaseScope, defById, diceRollEffect, findById, getCardEffects, getOnEventEffects, playerById, removeAttachment, removeById, roll2d6, toCardInstance, updateAttachment, updateCharacter, updatePlayer, wrongActionType } from './reducer-utils.js';
...
import { pruneLeaderFollowers, nextStrikePhase, eliminateCombatantFromStrike, handleResolveStrike } from './combat-strike.js';
import { handleCancelAttack, handleCancelByTap, resolveChainStrikeModifier } from './combat-cancel.js';
