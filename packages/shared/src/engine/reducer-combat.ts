...
import type { GameState, CombatState, StrikeAssignment, GameAction, GameEffect, CardInstanceId, CardDefinitionId, CardDefinition, Company } from '../index.js';
...
import type { ModifyAttackEffect, StrikeModifierEffect, HalveStrikesEffect, AbsorbWoundEffect, TriggerAttackOnPlayEffect, CombatTapCompanyBoostEffect } from '../types/effects.js';
...
import { makeCombatState, cardName, clonePlayers, companyById, companySubphaseScope, defById, diceRollEffect, findById, getCardEffects, getOnEventEffects, playerById, removeAttachment, removeById, roll2d6, toCardInstance, updateAttachment, updateCharacter, updatePlayer, wrongActionType } from './reducer-utils.js';
import { applyCost } from './cost-evaluator.js';
import { resolveEnemyBody, resolveAttackProwess, resolveAttackStrikes, normalizeCreatureRace, resolveDef } from './effects/index.js';
...
import { getAttackSourceCard, handleCombatPlayHazard, findTakePrisonerHazard, applyTakePrisoner, applyTakePrisonerAtSite } from './combat-hazard-play.js';
import { finalizeCombat, applyRule8_22AfterTrophyDecision, recordHazardEncountered, discardCardTriggeredCard } from './combat-finalize.js';
