...
import { resolveDef, getItemGrantedSkills, getEffectiveNaturalSkills } from './effects/index.js';
      ...
      for (const co of caster.companies) {
        ...
        for (const cid of co.characters) {
          ...
          const usesShadowMagic = isRingwraith
            || [...getEffectiveNaturalSkills(state, ch, cDef), ...getItemGrantedSkills(state, ch)].includes('shadow-magic');
