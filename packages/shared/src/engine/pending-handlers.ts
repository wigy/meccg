...
import {
  ...
  applyGoodwillAttemptResolution,
  applyRiddlingAttemptResolution,
  applyRiddlingGuessResolution,
  applySwapNewSiteChoiceResolution,
  applyBurglaryAttemptResolution,
  ...
  applyNamedCardPlayOfferResolution,
  applyItemPlacementOfferResolution,
  applyDragonAmbushOfferResolution,
  ...
  applyGreatSecretsChooseItemResolution,
  applyTapOrRollChoiceResolution,
  applyItemOrWoundChoiceResolution,
  ...
  applyChoosePeekDeckResolution,
  applyGreatHuntSourceResolution,
  applyGreatHuntDiscardAttackResolution,
  applyHuntTargetChoiceResolution,
  applyRevealDeckChooseAttackerResolution,
...
import {
  ...
  goodwillAttemptRollActions,
  riddlingAttemptRollActions,
  riddlingGuessActions,
  swapNewSiteChoiceActions,
  burglaryAttemptRollActions,
  seizedByTerrorRollActions,
  companyTapRollActions,
  opposedRollActions,
  goldRingTestActions,
  ringPlayOfferActions,
  namedCardPlayOfferActions,
  itemPlacementOfferActions,
  dragonAmbushOfferActions,
...
export const PENDING_HANDLERS: { readonly [K in PendingKindType]: PendingHandler } = {
  ...
  'goodwill-attempt': { legalActions: goodwillAttemptRollActions, apply: applyGoodwillAttemptResolution },
  'riddling-attempt': { legalActions: riddlingAttemptRollActions, apply: applyRiddlingAttemptResolution },
  'riddling-guess': { legalActions: riddlingGuessActions, apply: applyRiddlingGuessResolution },
  'swap-new-site-choice': { legalActions: swapNewSiteChoiceActions, apply: applySwapNewSiteChoiceResolution },
  'burglary-attempt': { legalActions: burglaryAttemptRollActions, apply: applyBurglaryAttemptResolution },
  ...
  'event-maintenance': { legalActions: eventMaintenanceActions, apply: applyEventMaintenanceResolution },
  ...
  'hand-discard-recycle-offer': { legalActions: handDiscardRecycleOfferActions, apply: applyHandDiscardRecycleOfferResolution },
  'arrange-deck-top': { legalActions: arrangeDeckTopActions, apply: applyArrangeDeckTopResolution },
  'rearrange-defender-deck': { legalActions: rearrangeDefenderDeckActions, apply: applyRearrangeDefenderDeckResolution },
  ...
  'great-secrets-choose-item': { legalActions: greatSecretsChooseItemActions, apply: applyGreatSecretsChooseItemResolution },
  'tap-or-roll-choice': { legalActions: tapOrRollChoiceActions, apply: applyTapOrRollChoiceResolution },
  'item-or-wound-choice': { legalActions: itemOrWoundChoiceActions, apply: applyItemOrWoundChoiceResolution },
  ...
  'remove-corruption-offer': { legalActions: removeCorruptionOfferActions, apply: applyRemoveCorruptionOfferResolution },
  'choose-peek-deck': { legalActions: choosePeekDeckActions, apply: applyChoosePeekDeckResolution },
  ...
  'hunt-target-choice': { legalActions: huntTargetChoiceActions, apply: applyHuntTargetChoiceResolution },
  'reveal-deck-choose-attacker': { legalActions: revealDeckChooseAttackerActions, apply: applyRevealDeckChooseAttackerResolution },
