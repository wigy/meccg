...
export const PENDING_HANDLERS: { readonly [K in PendingKindType]: PendingHandler } = {
  ...
  'muster-roll': { legalActions: musterRollActions, apply: applyMusterRollResolution },
  'flattery-attempt': { legalActions: flateryAttemptRollActions, apply: applyFlateryAttemptResolution },
  'call-of-home-roll': { legalActions: callOfHomeRollActions, apply: applyCallOfHomeRollResolution },
  ...
  'body-check-company': { legalActions: bodyCheckCompanyActions, apply: applyBodyCheckCompanyResolution },
  'ring-play-offer': { legalActions: ringPlayOfferActions, apply: applyRingPlayOfferResolution },
  'resource-play-offer': { legalActions: resourcePlayOfferActions, apply: applyResourcePlayOfferResolution },
  ...
  'glamour-hazard-roll': { legalActions: glamourHazardRollActions, apply: applyGlamourHazardRollResolution },
  ...
  'cvcc-ally-discard-roll': { legalActions: cvccAllyDiscardRollActions, apply: applyCvccAllyDiscardRollResolution },
